...
bool EnableOrDisableService(const char* strServiceName, bool bIsEnable)
{
	bool bResult = false;
	...
	{
		hService = OpenService(hServiceControlManager, strServiceName, SERVICE_CHANGE_CONFIG);
...
VOID __stdcall DoStopSvc(const char* szSvcName)
{
	SERVICE_STATUS_PROCESS ssp;
	DWORD dwStartTime = GetTickCount();
	DWORD dwBytesNeeded;
...
int main(int argc, char** argv) {
	Log("Stopping Windows Update...");
	DoStopSvc("wuauserv");
	EnableOrDisableService("wuauserv", false);
